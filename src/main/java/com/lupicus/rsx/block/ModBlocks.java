...
public class ModBlocks
{
	...
	public static final Block REDSTONE_PIPE_BLOCK = new RedstonePipeBlock(Properties.create(Material.MISCELLANEOUS).notSolid().hardnessAndResistance(0.25F).sound(SoundType.GLASS)).setRegistryName("redstone_pipe_block");
